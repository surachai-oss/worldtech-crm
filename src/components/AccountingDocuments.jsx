...
const UPLOADABLE_STATUSES = [
  ...
  ACCOUNTING_DOC_STATUS.ADDITIONAL_REQUEST,
]
// สถานะที่ต้องผ่านขั้นตรวจสอบก่อน (ข้อมูลไม่ครบ/อนุมัติ) — ขอเอกสารเพิ่มก็ต้องตรวจแบบเดียวกับคำขอใหม่ แค่แยกป้ายให้เห็นว่าเคยเสร็จไปรอบหนึ่งแล้ว
const REVIEWABLE_STATUSES = [ACCOUNTING_DOC_STATUS.PENDING_REVIEW, ACCOUNTING_DOC_STATUS.ADDITIONAL_REQUEST]
    ...
    <div className="modal-overlay" onMouseDown={e => { if (e.target === e.currentTarget) onClose() }}>
      <div className="modal" style={{ maxWidth: 700 }}>
        ...
        <div className="modal-body">
          ...
          {REVIEWABLE_STATUSES.includes(req.document_status) && (
