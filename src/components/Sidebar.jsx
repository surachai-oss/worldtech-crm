...
// "ตั้งค่าเอกสาร" ไม่มีเมนูของตัวเอง — เข้าจากปุ่มข้าง "สร้างใบเสนอราคา" ในหน้าใบเสนอราคาเท่านั้น
// (ยังมี view 'document-settings' ใน App.jsx อยู่ แค่ไม่มีรายการในเมนูด้านซ้าย)
...
export default function Sidebar({ activeView, onNav, user, isAdmin, isFinance, onLogout }) {
  ...
  // "ต้นทุนสินค้า" = Cost Master ของระบบเช็คราคา — บัญชี/แอดมินเท่านั้น (เซลล์เห็นแต่ผลลัพธ์ ไม่เห็นต้นทุน)
