...
- ทุกคนที่ login เข้าระบบแล้ว **แก้ไข/ลบตัวเลือกได้ทุกคน** (ไม่ใช่แค่ admin) ตามที่ตกลงกันไว้ — ถ้าอยากจำกัดเฉพาะ admin แจ้งได้ จะแก้ RLS policy `picklists write` ให้
