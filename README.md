...
### นำเข้าบริษัทลูกค้าจากไฟล์ + ที่มาลูกค้า + แนบเอกสารตอนสร้างบริษัท
...
- ฟอร์มเพิ่ม/แก้ไขบริษัทมีช่อง **"ที่มา"** (lead source) เป็น dropdown ที่ Admin จัดการรายการเองได้ที่เมนู "ที่มาลูกค้า" (Sidebar) และมีช่องแนบเอกสาร (ภพ20, หนังสือรับรองบริษัท ฯลฯ) ได้เลยตอนสร้าง/แก้ไขบริษัท — ไฟล์จะถูกเก็บในระบบเอกสารแนบเดียวกับแท็บ "เอกสารแนบ"
