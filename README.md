...
### นำเข้าผู้ติดต่อจากไฟล์
- หน้า "ผู้ติดต่อ" มีปุ่ม **"📥 นำเข้าจากไฟล์"** เหมือนหน้าบริษัท — ใช้เวลามีลูกค้าติดต่อเข้ามาเป็นชุด (เช่น กรอกฟอร์มจากเฟซบุ๊ก/เว็บไซต์) แล้วอยากนำเข้าทีเดียวแทนการเพิ่มทีละคน
- ไฟล์ต้องมีคอลัมน์ **"ชื่อบริษัท"** ที่สะกด**ตรงกับชื่อบริษัทที่มีอยู่ในระบบเป๊ะ** (ไม่ตัวพิมพ์เล็ก/ใหญ่ก็ได้ แต่ต้องเป็นบริษัทเดิม เพราะผู้ติดต่อต้องผูกกับบริษัทที่มีอยู่แล้วเท่านั้น) — ถ้ายังไม่มีบริษัทนั้นในระบบ ต้องไปเพิ่มบริษัทก่อน แล้วค่อยนำเข้าผู้ติดต่อ
- แถวที่หาไม่เจอบริษัทที่ตรงกัน หรือไม่กรอกชื่อ-นามสกุล จะถูกตีเป็นแถวผิดพลาดและไม่ถูกนำเข้า (พรีวิวให้เห็นก่อนกดยืนยัน)
