...
- เมนู "สินค้า" (ในหมวดผู้ดูแลระบบ) ใช้จัดการรายชื่อสินค้าที่เลือกได้ในดีล — มีแค่ **รหัสสินค้า + ชื่อสินค้า** ไม่ได้เก็บราคาไว้ล่วงหน้า เพราะราคาต่อหน่วยกรอกใหม่ทุกครั้งตอนสร้างดีล เพิ่ม/แก้ไข/ลบสินค้าได้เฉพาะ admin เช่นเดียวกับ Picklists
...
- ปรับรูปแบบใบเสนอราคาที่พิมพ์/บันทึกเป็น PDF ใหม่ทั้งหมด ให้ตรงกับแบบฟอร์มที่บริษัทใช้จริง — แถบหัวกระดาษสีกรมท่า โลโก้ + ข้อมูลบริษัท, เลขที่/วันที่, ข้อมูลลูกค้าพร้อมเลขผู้เสียภาษี, ตารางรายการสินค้า, กล่องสรุปยอด (ไม่รวม VAT / VAT 7% / ยอดชำระ), หมายเหตุ, และกล่องข้อมูลติดต่อ
